...
| conditional predicate | <per>/[aField="aValue"] or /property[aField="aValue" || aField="aValue2"] or /property[aField="Avalue"]/property2 or /property[aField="aValue" && Afield2="AValue"]/[aField="aValue"] </pre>| Simple filters to norrow down the elements selected, operators supported are : &&, ||, <=, >=, ==, != |
|  |  |  |
